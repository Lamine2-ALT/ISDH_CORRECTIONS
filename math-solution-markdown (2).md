...
Soit $x=\frac{4}{7+3\sqrt{5}}$.

$x = \frac{4}{7+3\sqrt{5}} \times \frac{7-3\sqrt{5}}{7-3\sqrt{5}}$

$x= \frac{4(7-3\sqrt{5})}{(7+3\sqrt{5})(7-3\sqrt{5})}$

$x = \frac{4(7-3\sqrt{5})}{7^2 - (3\sqrt{5})^2}$

$x= \frac{4(7-3\sqrt{5})}{49 - 45}$

$x= \frac{4(7-3\sqrt{5})}{4}$
...
Comme deux nombres positifs sont rangés dans le même ordre que leurs carrés, 

on obtient $3\sqrt{5} < 7$, donc $y = 3\sqrt{5} - 7 < 0$.
...
On sait que $2,236< \sqrt{5}< 2,237$. En multipliant par 3 chaque membre on a :
